...
def validate(args=None):
    ...
    trained_state_dict = torch.load('/home/zhonggai/python-work-space/WSSS-work/Token-contrast/ToCo-main/scripts/work_dir_voc_wseg/CPC(proj_fusion_map)/checkpoints/default_model_iter_30000.pth', map_location="cpu")
