...
parser.add_argument("--model_path", default="/home/zhonggai/python-work-space/WSSS-work/Token-contrast/ToCo-main/scripts/work_dir_voc_wseg/1.8减小ccr权重/checkpoints/default_model_iter_40000.pth", type=str, help="model_path")

parser.add_argument("--backbone", default='vit_base_patch16_224', type=str, help="vit_base_patch16_224")
parser.add_argument("--data_folder", default='../VOC2012', type=str, help="dataset folder")
parser.add_argument("--list_folder", default='/home/zhonggai/python-work-space/WSSS-work/Token-contrast/ToCo-main/datasets/voc', type=str, help="train/val/test list file")
