...
from model.losses import get_masked_ptc_loss,get_mask_consistency_loss, get_seg_loss, ContrastLoss_prototype_instance_bg,ContrastLoss_prototype_instance, DenseEnergyLoss, get_energy_loss,CPCLoss,get_PABCE_loss,ContrastLoss_moco,ContrastLoss_prototype,get_bg_fg_contrastive_clamp_loss,get_bg_fg_contrastive_loss
...
from utils.camutils import single_instance_crop_v2,single_instance_crop_bg,cam_to_label, cam_to_roi_mask2, multi_scale_cam2, label_to_aff_mask, refine_cams_with_bkg_v2,cam_to_label_resized,get_per_pic_thre,multi_scale_cam2_du_heads,select_local_patch
...
#get_local_pic_to_encode------------------------------------------------------------------------------
        ...
        # b1_local_crops, b1_flags, b1_box= single_instance_crop_bg(images=inputs, cls_label = cls_label,roi_mask_28x=b1_roi_mask, crop_num=n_crops, crop_size=args.local_crop_size, refine_pesudo_label= refined_roi_mix_pesudo_label)
        # b2_local_crops, b2_flags, b2_box= single_instance_crop_bg(images=inputs, cls_label = cls_label,roi_mask_28x=b2_roi_mask, crop_num=n_crops, crop_size=args.local_crop_size, refine_pesudo_label= refined_roi_mix_pesudo_label)
...
# branch2 : adaptive-label-bce + cls loss part-------------------------------------------------------------------------------------------------------------------
        ...
        _28x_aux_cam = F.interpolate(b2_cams_aux.detach(), size=(28,28), mode="bilinear", align_corners=False)
        aux_pesedo_show = b2_refined_aux_pesudo_label = cam_to_roi_mask2(_28x_aux_cam.detach(), cls_label=cls_label, low_thre=args.low_thre, hig_thre=args.high_thre)
        ...
        # per_pic_thre = get_per_pic_thre(b2_refined_aux_pesudo_label, gd_label=cls_label, uncertain_region_thre = args.uncertain_region_thre)
        b2_spacial_bce_loss = get_PABCE_loss(b2_cam_12th, cls_label, per_pic_thre, b2_refined_aux_pesudo_label )
