...
#pretrained_load——————————————————————————————————————————————————————————————————————————————————————————————————
    ...
    b1_contrast_prototype = ContrastLoss_prototype_instance(num_cls=80)
    b2_contrast_prototype = ContrastLoss_prototype_instance(num_cls=80)
...
#train------------------------------------------------------------------------------------------------------------------------
        if n_iter <= 8000:
            ...
            loss = (0.2 * b2_spacial_bce_loss + 0.8 * b2_cls_loss) + 1.0 * b1_cls_loss+ 1.0 * (b1_cls_loss_aux + b2_cls_loss_aux) + args.w_ptc * ptc_loss + args.w_seg * seg_loss + 0.1 * network_sim_loss + 0.05 * contrast_loss
