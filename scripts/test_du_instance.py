...
from utils.camutils import single_instance_crop,single_bg_fg_crop_denoise_v3,cam_to_label, cam_to_roi_mask2, multi_scale_cam2, label_to_aff_mask, refine_cams_with_bkg_v2,cam_to_label_resized,get_per_pic_thre,multi_scale_cam2_du_heads,select_local_patch
...
#get_local_pic_to_encode------------------------------------------------------------------------------
        ...
        b1_local_crops, b1_flags, b1_box= single_instance_crop(images=inputs, cls_label = cls_label,roi_mask_28x=b1_roi_mask, crop_num=n_crops, crop_size=args.local_crop_size, roi_mask = b1_roi_mask)
        b2_local_crops, b2_flags, b2_box= single_instance_crop(images=inputs, cls_label = cls_label,roi_mask_28x=b2_roi_mask, crop_num=n_crops, crop_size=args.local_crop_size, roi_mask = b2_roi_mask)
