...
#pretrained_load——————————————————————————————————————————————————————————————————————————————————————————————————
    ...
    trained_state_dict = torch.load('/home/zhonggai/python-work-space/DEFormer/DEFormer/scripts/work_dir_voc_wseg/74.0(crop = 80)/checkpoints/default_model_iter_8000.pth', map_location="cpu")
